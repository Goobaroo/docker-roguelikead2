...
if ! [[ -f "RAD2-Serverpack-1.13.zip" ]]; then
  curl -Lo 'RAD2-Serverpack-1.13.zip' 'https://edge.forgecdn.net/files/6095/292/RAD2-Serverpack-1.13.zip' && unzip -u -o 'RAD2-Serverpack-1.13.zip' -d /data
