...
if ! [[ -f "RAD2-Serverpack-1.14.zip" ]]; then
  curl -Lo 'RAD2-Serverpack-1.14.zip' 'https://edge.forgecdn.net/files/6698/101/RAD2-Serverpack-1.14.zip' && unzip -u -o 'RAD2-Serverpack-1.14.zip' -d /data
