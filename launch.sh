...
if ! [[ -f "RAD2-Serverpack-1.7.zip" ]]; then
  curl -Lo 'RAD2-Serverpack-1.7.zip' 'https://edge.forgecdn.net/files/4777/217/RAD2-Serverpack-1.7.zip' && unzip -u -o 'RAD2-Serverpack-1.7.zip' -d /data
