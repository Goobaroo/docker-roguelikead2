...
if ! [[ -f "RAD2-Serverpack-1.17.zip" ]]; then
  curl -Lo 'RAD2-Serverpack-1.17.zip' 'https://edge.forgecdn.net/files/7486/703/RAD2-Serverpack-1.17.zip' && unzip -u -o 'RAD2-Serverpack-1.17.zip' -d /data
