# [RAD2 - 1.10a ](https://www.curseforge.com/minecraft/modpacks/roguelike-adventures-and-dungeons-2) on Curseforge
...
The docker on first run will download the same version as tagged of RAD2 - 1.10a  and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "RAD2 - 1.10a  Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-roguelikead2

Docker: https://hub.docker.com/repository/docker/goobaroo/roguelikead2