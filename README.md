# [RAD2 - 1.14 ](https://www.curseforge.com/minecraft/modpacks/roguelike-adventures-and-dungeons-2) on Curseforge
...
The docker on first run will download the same version as tagged of `RAD2 - 1.14 ` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "RAD2 - 1.14  Server Powered by Docker"
* LEVEL world
